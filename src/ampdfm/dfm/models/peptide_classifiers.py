...
from models.peptide_models import CNNModelPep, CNNModel, MLPModel
...
def load_solver(checkpoint_path, vocab_size, device):
    lr = 1e-4
    epochs = 200
    # Match the architecture used during training of the provided checkpoint
    embed_dim = 1024
    hidden_dim = 512
    epsilon = 1e-3
    batch_size = 256
    warmup_epochs = epochs // 10
    # Respect caller-specified device instead of forcing CUDA.
    # This allows testing on CPU-only nodes (or choosing a different GPU).
