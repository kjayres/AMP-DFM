...
class MixtureDiscreteEulerSolver(Solver):
    ...
    def multi_guidance_sample(
        ...
        **model_extras,
        ...
        w, _ = select_random_weight_vector(len(importance), args.num_div)
        ...
        with ctx:
            for i in range(n_steps):
                ...
                if i != n_steps - 1:
                    ...
                    guided_u_t, pos_indices, cand_tokens, improvement_values, delta_S = guided_transition_scoring(x_t, u_t, w, score_models, t, importance, args)
