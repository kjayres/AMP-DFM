#!/usr/bin/env python3
"""pepdfm_conditional_finetune.py

Fine-tune the PepDFM CNN with a 4-bit conditioning vector [AMP, EC, PA, SA]
on the same tokenised dataset produced by `prepare_pepdfm_dataset.py` which now
...
Outputs: ampflow/ampdfm_ckpt/pepdfm_conditional_finetuned.ckpt
"""
...
TRAIN_PATH = "./ampflow/ampdfm_data/tokenized_amp/train"
VAL_PATH   = "./ampflow/ampdfm_data/tokenized_amp/val"

INIT_CKPT = "./ampflow/ampdfm_ckpt/pepdfm_unconditional_epoch200.ckpt"
CKPT_OUT  = "./ampflow/ampdfm_ckpt/pepdfm_conditional_finetuned.ckpt"
...
lr            = 5e-5  # lower LR for fine-tune
epochs        = 50
...
parser = argparse.ArgumentParser(description="Fine-tune PepDFM with 4-bit conditioning vector")
