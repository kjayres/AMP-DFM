...
def main():
    ...
    # Assign train/val/test splits at cluster level
    ...
    # Tables to be split – use the final cleaned versions and both negative sources
    datasets = [
