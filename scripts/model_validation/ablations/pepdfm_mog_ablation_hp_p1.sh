...
#PBS -N pepdfm_ablate_p1
#PBS -j oe
#PBS -o /rds/general/user/kja24/home/mog_dfm/ampflow/ablations/pepdfm_mog_ablation_hp_p1.o$PBS_JOBID
#PBS -e /rds/general/user/kja24/home/mog_dfm/ampflow/ablations/pepdfm_mog_ablation_hp_p1.e$PBS_JOBID
