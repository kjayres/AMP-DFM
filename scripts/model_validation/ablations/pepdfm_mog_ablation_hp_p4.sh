...
#PBS -N pepdfm_ablate_p4
#PBS -j oe
#PBS -o /rds/general/user/kja24/home/mog_dfm/ampflow/ablations/pepdfm_mog_ablation_hp_p4.o$PBS_JOBID
#PBS -e /rds/general/user/kja24/home/mog_dfm/ampflow/ablations/pepdfm_mog_ablation_hp_p4.e$PBS_JOBID
...
# Part 4: two ablations
IMPS=(
  "1,0,1"  # potency + cytotox
  "1,1,1"  # all three
)
