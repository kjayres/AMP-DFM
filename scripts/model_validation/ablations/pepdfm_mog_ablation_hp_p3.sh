...
#PBS -N pepdfm_ablate_p3
#PBS -j oe
#PBS -o /rds/general/user/kja24/home/mog_dfm/ampflow/ablations/pepdfm_mog_ablation_hp_p3.o$PBS_JOBID
#PBS -e /rds/general/user/kja24/home/mog_dfm/ampflow/ablations/pepdfm_mog_ablation_hp_p3.e$PBS_JOBID
...
# Part 3: two ablations
IMPS=(
  "0,1,1"  # both safety judges
  "1,1,0"  # potency + hemolysis
)
