...
python /rds/general/user/kja24/home/amp_dfm/scripts/train_dfm/ampdfm_uncond_sample.py --config /rds/general/user/kja24/home/amp_dfm/configs/flow_matching/ampdfm_uncond_sample.yaml
