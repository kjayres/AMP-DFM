...
python /rds/general/user/kja24/home/amp_dfm/scripts/train_dfm/ampdfm_conditional_finetune.py --config /rds/general/user/kja24/home/amp_dfm/configs/flow_matching/ampdfm_conditional_finetune.yaml --device cuda --amp_only "$@"